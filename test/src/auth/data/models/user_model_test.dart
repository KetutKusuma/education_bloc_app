...
void main() {
  ...
  group('fromMap', () {
    test('should return a valid [LocalUserModel] from a map', () {
      // act
  ...
  group('toMap', () {
    //
    test('should return a valid data map from [LocalUserModel]', () {
  ...
  group('copyWith', () {
    //
    test('should return a valid [LocalUserModel] with updates value', () {
      //
